      ...
      <div className="min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center px-4 py-16">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          >
            ...
            <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-primary-blue/20 rounded-full blur-3xl" />
          </motion.div>
          ...
          >
            <Link to="/alapfogalmak">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 rounded-xl bg-gradient-to-r from-primary-purple to-primary-blue text-white font-semibold text-lg shadow-lg shadow-primary-purple/25 hover:shadow-primary-purple/40 transition-shadow"
              >
                Kezdjük el →
              </motion.button>
            </Link>
